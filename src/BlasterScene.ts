...
export default class BlasterScene extends THREE.Scene
{
	...
	private updateInput()
	{
		...
		{
			this.blaster.position.add(this.directionVector.clone().multiplyScalar(speed))
		}
	...
	private async createBullet()
	{
		...
		const vecBasterPos = this.blaster.position.clone()
		vecBasterPos.y += 0.06
		...
		bulletModel.rotateX(Math.PI * -0.5)
